...
from detectlib.models.net import MobileNetV1 as MobileNetV1
from detectlib.models.net import FPN as FPN
from detectlib.models.net import SSH as SSH
...
class RetinaFace(nn.Module):
    def __init__(self):
        ...
        in_channels_stage2 = 32#cfg['in_channel']
        in_channels_list = [
